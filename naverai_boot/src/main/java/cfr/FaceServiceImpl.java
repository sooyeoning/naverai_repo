...
public class FaceServiceImpl implements NaverService{
	...
	public String test(String image) {
        ...
        try {
            String paramName = "image"; // apiURL이 요구하는 파라미터명은 image로 지정
            String imgFile = path + image; //전달받은 매개변수 사용
        ...
        return response.toString(); //서비스 결과인 response값 리턴
